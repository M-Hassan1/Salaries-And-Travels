  ...
  export const columns = [
    {
      ...
      render: (_, record) => (
        <div className="w-full gap-x-2 flex items-center justify-start sm:flex-col sm:items-start">
          <Image src={'/resort.svg'} width={51} height={51} />
          <div className="text-base sm:text-sm font-lato font-normal text-[#777777]">
            <span className="pt-2 text-[#000000]">The Best Resort</span>
